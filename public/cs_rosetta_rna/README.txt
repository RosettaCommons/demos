...
USAGE:
    ...
    (1) Refine (minimize) and score a PDB structure under the hybrid
        CS-ROSETTA-RNA all-atom energy function:
        ---------------------------------------
    ...
    (2) Score (but not refine) a PDB structure under the hybrid
        CS-ROSETTA-RNA all-atom energy function:
        ---------------------------------------
...
OPTIONAL_ARGS:
    ...
    -----------------------------------------
        ...
        Specify how to handle assignment of the diastereotopic H5' and H5''
        proton pair.
        ...
        Valid modes:
            ...
            ----------------------------------------
                In this mode, the assignments of H5' and H5'' protons will be
                based on which values give better agreement between the
                experimental and back-calculated chemical shifts.

                Uses this mode, if the experimental non-exchangeable 1H chemical
                shift are not unambiguously assigned.

            UNIQUE
            ------
                In this mode, the assignments H5' and H5'' proton will be used
                "as is" and the cs_rosetta_rna will not attempt to switch the
                H5' and H5'' assignments.
...
OUTPUTS:
    ...
    Outputs of the cs_rosetta_rna includes
    --------------------------------------
        ...
        (4) The RNA PDB structure after refinement under the hybrid
            CS-ROSETTA-RNA all-atom energy function (if -mode minimize_pdb).

            The refined PDB is outputted to the run directory under the
            filename: "<in_pdb_basename>_out".
...
BEST_PRACTICES
    ...
    -----------------------------------
        ...
        a. Add a "OBLIGATE  PAIR" line for each helical base-pair located
        ...
        b. Add "ALLOW_INSERT" lines to include all non-canonical loop
        ...
        c. Add "CUTPOINT_CLOSED" line to include the position intermediately 5'
        ...
        d. Add "CUTPOINT_OPEN" line for all position intermediately 5' of 
           chain-breaks.
    ...
    How to specify the chemical shift data for the diastereotopic H5' and H5''
    proton pairs.
    -------------
