...
#	CVS information:
#	$Revision: 14374 $
#	$Date: 2007-04-19 10:47:46 -0700 (Thu, 19 Apr 2007) $
#	$Author: tex $
...
# psi-blast
my $N_PROCS = 4;
my $PSIBLAST = "/work/tex/src/blast/bin/blastpgp -a $N_PROCS";		 # PSI-BLAST (duh.)
...
my $MAKEMAT = "/work/tex/src/blast/bin/makemat";			 # makemat utility (part of NCBI tools)
#my $PSIPRED = "/work/tex/src/psipred/bin/psipred";			 # psipred
my $PSIPRED = "/work/tex/psipred_2.61/bin/psipred";
my $PSIPASS2 = "/work/tex/psipred_2.61/bin/psipass2";		 # psipass2 (part of psipred pkg)
my $PSIPRED_DATA = "/work/tex/psipred_2.61/data";				 # dir containing psipred data files.
...
my $NNMAKE = "/work/tex/src/nnmake/pNNMAKE.gnu";												 # nnmake binary	(cvs respository 'nnmake')
...
unless (-f <$xx$id$chain*$TAIL>) {
    ...
    #print "running cmd $NNMAKE $xx $id $chain!\n";
	}
...
sub try_try_again {
  ...
  print "cmd = $cmd\n";
  print "trying to run cmd $max_tries times!\n";
	my $try_count = 0;
	my $missing_files = 1;
	my $f;
