...
def print_help():
    ...
    print "\n",
    print "written by Phil Bradley, Rhiju Das, Michael Tyka, TJ Brunette, and James Thompson from the Baker Lab. Edits done by Steven Combs and Sam Deluca from the Meiler Lab."
    sys.exit()
...
if nres > 0:
	...
	fastaid.write('\n')
	handle = open(pdbname[0:4]+"_"+chainid + ".fasta", 'w')
	handle.write('>'+pdbname[0:4]+"_"+chainid+'\n')
