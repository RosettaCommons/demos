...
###################
#
#  EXAMPLE 1 - Docking of an insulin dimer (chains A, B, C, D in 1ZEH.pdb) into a trimer of dimers -> C3 symmetry
#

1.0  Clean up the pdb file if need be.
...
2.0 Generating the symmetry file:
...
######################################
#
#  EXAMPLE 2 - Docking of six monomers (chains A + B in 1ZEH.pdb) into a trimer of dimers -> D3 symmetry
#

1.0  Clean up the pdb file.
