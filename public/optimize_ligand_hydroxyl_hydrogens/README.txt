...
3) Make a params file for the ligand
...
6) If desired, use a more complete energy function and more sampling as in this example flags file
Recommended full flags for a more careful run:
enzdes_flags

7) This setup can also be used for full enzyme design
