...
ROSETTA_BIN="/vol/ek/share/rosetta-3.4/rosetta_source/bin"
ROSETTA_DB="/vol/ek/share/rosetta-3.4/rosetta_database"
	...
	do
		...
		#$ROSETTA_BIN/FlexPepDocking.linuxgccrelease -s $i.pdb  -database $ROSETTA_DB -ex1 -ex2aro -use_input_sc -flexpep_prepack -scorefile score.ppk.sc -nstruct 1  > ppk.log
