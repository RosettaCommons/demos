...
# Rosetta options
opts = '-multiple_processes_writing_to_one_directory -mute core -mute protocols -mute basic -include_surfaces'
...
score_high.set_weight(fa_elec, hackelec)
...
score_pack.set_weight(fa_elec, hackelec)
...
std_scorefxn.set_weight(fa_elec, hackelec)
