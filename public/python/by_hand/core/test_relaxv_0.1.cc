...
// struct PackerTask_wrapper : core::pack::task::PackerTask, bp::wrapper< core::pack::task::PackerTask > /*, utility::pointer::ReferenceCount*/ {
//
//     PackerTask_wrapper(core::pack::task::PackerTask const & arg )
//     : core::pack::task::PackerTask( arg )
...
// utility::pointer::owning_ptr<PackerTask_wrapper> create_packer_task_as_reference( core::pose::Pose const & pose ) {
//   return utility::pointer::owning_ptr<PackerTask_wrapper>
//       (new PackerTask_wrapper(*core::pack::task::TaskFactory::create_packer_task(pose)));
// }
// PackerTask_wrapper * create_packer_task_as_reference( core::pose::Pose const & pose ) {
//   return (new PackerTask_wrapper(*core::pack::task::TaskFactory::create_packer_task(pose)));
// }
...
BOOST_PYTHON_MODULE(_test_relax){
	// bp::def( "create_packer_task", create_packer_task_as_reference
	//        ,  bp::return_value_policy<bp::manage_new_object>() );
		...
		// bp::class_< PackerTask_wrapper >( "PackerTask" )
		//     .def(
		//         "bump_check"
		...
		bp::class_< Mover_wrapper, boost::noncopyable >( "Mover", bp::init< std::string const & >(( bp::arg("type_in") )) )
				.def(
						"acceptance_rate"
