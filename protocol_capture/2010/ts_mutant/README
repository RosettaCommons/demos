...
# Protocol Name:
temperature-sensitive mutation prediction
...
All files are written to and read from the ts_mutant directory; the input_files and output_files directories are
ignored.
