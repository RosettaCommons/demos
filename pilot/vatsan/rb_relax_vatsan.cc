...
main( int argc, char * argv [] )
{
	...
	//		 111111, numeric::random::_RND_ConstantSeed_, "ran3");
...
rb_relax_test()
{
	...
	core::pose::Pose pose;
	std::cout << "rb_relax_viewer" << std::endl;
	//uncomment all of these when it is ready to run
	//	core::io::pdb::pose_from_pdb( pose, option[ OptionKeys::looprelax::input_pdb ]().name() );
	devel::SSrbrelax::RbRelax myRbRelax;
	myRbRelax.apply( pose );
