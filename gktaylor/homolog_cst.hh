...
void add_constraints (
		...
		while( getline( data, line ) ) {
			...
			cst_set->add_constraint(
				new core::scoring::constraints::AtomPairConstraint(
					...
					new core::scoring::constraints::HarmonicFunc( dist, 2.0 )
	...
	utility::vector1< core::scoring::constraints::ConstraintOP > cst_list = cst_setOP->get_all_constraints();
...
void create_starting_template (
	...
	mapping.show();
	core::io::pdb::pose_from_pdb( *template_pose, template_id );
