...
##### Caveat: Even if a residue's backbone and sidechain torsion movements are turned off in a move map, it's relative position with respect to other residues may still change depending on the motion of residues upstream in the FoldTree.
